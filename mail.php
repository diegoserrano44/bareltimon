...
$address = "bareltimon@bareltimon.cat";
...
$e_body = "You have been contacted by $form_name. $first_name selected service of $select_service, their additional message is as follows. Customer max budge is $select_price, for this project." . PHP_EOL . PHP_EOL;
